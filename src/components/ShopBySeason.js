...
export default function ShopBySeason() {
  return (
    <section className="bg-[var(--fa-cream)] py-10 md:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 md:gap-6">
          {SEASONS.map((s) => (
            <Link
              key={s.label}
              href={s.href}
              className="group block overflow-hidden border border-[var(--fa-hover-dark)] shadow-[0_8px_24px_rgba(0,0,0,0.12)] transition-shadow duration-300 hover:shadow-[0_0_0_1px_rgba(209,174,109,0.45),0_14px_38px_rgba(209,174,109,0.22)]"
            >
