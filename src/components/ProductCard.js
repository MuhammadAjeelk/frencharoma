  ...
  return (
    ...
    >
      ...
      <div className="relative w-full aspect-[6.818/7.5] overflow-hidden bg-[#f7f5f2]">
        ...
        {isBestSeller && (
          <span className="absolute bottom-2 left-2 z-10 flex items-center gap-1 bg-[#1a1a2e]/95 text-white rounded-full px-2 py-0.5 text-[10px] font-bold shadow-sm">
            <svg className="w-3 h-3 text-[#e0a800] fill-[#e0a800]" viewBox="0 0 20 20">
