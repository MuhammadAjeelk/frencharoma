              ...
              {sellable.map((e) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center justify-center gap-6 rounded-lg px-3 py-3 min-h-[46px] ${st.bar} ${st.text} shadow-sm transition-transform duration-200 hover:scale-[1.03]`}
                  >
