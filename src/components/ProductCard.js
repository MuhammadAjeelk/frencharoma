  ...
  return (
    ...
    >
      ...
      <div
        className={
          hoverReveal
            ? "absolute inset-0 z-20 p-3 sm:p-4 flex flex-col justify-center overflow-y-auto bg-[#f4f2ef]/97 backdrop-blur-[2px] transition-all duration-300 opacity-100 translate-y-0 lg:opacity-0 lg:translate-y-3 lg:group-hover:opacity-100 lg:group-hover:translate-y-0"
            : "p-3 sm:p-4 flex flex-col flex-1 bg-[#f4f2ef]"
        }
      >
        {/* Quick View at top of the revealed panel (hover-reveal mode) */}
        {hoverReveal && onQuickView && (
          <div className="flex justify-center mb-2.5">
            <button
              ...
              className="flex items-center gap-1.5 bg-white/95 backdrop-blur-sm px-3.5 py-1.5 rounded-full text-[11px] font-semibold text-[#1a1a2e] shadow-md hover:bg-white transition-colors"
            >
